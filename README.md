...
Проект решает задачу разузлования (преобразование связей "Материал-Компонент" в полное дерево) для производственных планов.
...
2.  **Transform (Трансформация - Python/Pandas):**
    ...
    *   Дедупликация записей (агрегация месячных планов в годовые уникальные связи).
